...
import { AudioWaveform, BookOpen, Bot, ChevronRight, Clock, Dices, Frame, GalleryVerticalEnd, Map, PieChart, Settings2, SquareTerminal, Star } from 'lucide-vue-next';
...
<template>
    <SidebarGroup class="space-y-2">
        <SidebarGroupLabel class="font-semibold text-base">Игры</SidebarGroupLabel>
        <SidebarMenu>
            ...
            <SidebarMenuItem v-for="item in data.navMain" :key="item.title" :default-open="item.isActive"
                :tooltip="item.title">
                <SidebarMenuButton class="p-0" :class="cn(
                    'duration-100',
